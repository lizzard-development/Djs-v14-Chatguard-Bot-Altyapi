...
module.exports = {
  ...
  execute(message, args, client) {
    ...
    const embed = new EmbedBuilder()
      ...
      .setDescription('❕ **Ares Code** guard yönetim paneline hoş geldiniz 🎉\n\n📍 Aşağıdaki butonlar aracılığıyla tüm guard bot fonksiyonlarını ayarlayabilirsin.\n\n⚠️ **Not**: **Güvenli Rol** butonu üzerinden ekleyeceğin role sahip olmayan birisi sunucudan **kanal silemez, rol silemez ve bot ekleyemez** lütfen dikkat edin.')
      ...
      .addFields(
        ...
        { name: '👑 Güvenli Rol', value: client.ayarlar.selfRoller.length > 0 ? '✅ Ayarlı' : '❌ Ayarlanmadı', inline: true }
      )
